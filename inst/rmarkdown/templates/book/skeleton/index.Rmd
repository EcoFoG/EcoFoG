...
knitr::opts_chunk$set(cache=TRUE, warning=FALSE, fig.env='SCfigure', out.width='80%', fig.asp=.75, fig.align='center', knitr.graphics.auto_pdf = TRUE)
...
Packages <- c("bookdown", "kableExtra", "knitr", "rmarkdown", "magrittr")

...
- Rétablir la création automatique de packages.bib.

- Changer le nom de book.bib.

- Documenter le YAML.

- Documenter la structure du document LaTeX.

- Documenter le changement de langue.

- Dupliquer la doc du modèle LaTeX : équations, etc.



## Documentation pour les utilisateurs

- L'ouvrage [bookdown: Authoring Books and Technical Documents with R Markdown](https://bookdown.org/yihui/bookdown/) de Yihui Xie, l'auteur de **bookdown** et de **knitr**.

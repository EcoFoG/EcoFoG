...
Ce modèle permet la rédaction de mémos au format Markdown[^4]. 
...
En LaTeX, Les tableaux peuvent avoir la largeur de la colonne et éventuellement d'étendre sur plusieurs pages\break `longtable = TRUE` ou bien utiliser la largeur de la page\break `longtable = FALSE` comme le tableau \@ref(tab:Paracou)) (ce qui n'a pas d'effet sur un document formaté sur une seule colonne).
...
Le projet peut être déposé sur Github[^5].

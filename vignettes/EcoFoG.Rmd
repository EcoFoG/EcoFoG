...
Pour installer le package à partir de GitHub, il faut utiliser le package _remotes_ après l'avoir lui-même installé comme tout autre package (menu _Tools/Install Packages..._).
